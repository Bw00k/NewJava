...
public class StringRef {
	public static void main(String[] args) {
		...
		//문자열 주소값으로 비교
		if(strVal1 == strVal2) {
			System.out.println("strVal1과 strVal2는 메모리 주소가"
		+ "같다");
		...
		if(strVal1 == strVal3) {
			...
			System.out.println("strVal과 strVal3은 다른 메모리 주소.");
		}
		if(strVal1.equals(strVal3)) {
			System.out.println("strVal1과 strVal3는 데이터 같다.");
		}else {
			System.out.println("strVal1과 strVal3는 데이터가 다르다.");
		}
	}
}
